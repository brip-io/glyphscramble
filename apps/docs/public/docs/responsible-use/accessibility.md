...
Limit protected output to non-essential content and acknowledge that it is not WCAG-conformant.

Source: https://glyphscramble.brip.io/docs/responsible-use/accessibility/
