...
Repair preparation, routing, font loading, content, and deployment failures without exposing text.

Source: https://glyphscramble.brip.io/docs/operations/troubleshooting/
