...
- The runtime benchmark gates a 102,420-byte response at 10 ms after explicit warmup; the local implementation run measured 7.896 ms p95 excluding variant acquisition.
